    ...
    <section class="py-32 bg-gradient-to-b from-slate-50 to-white">
        <div class="max-w-7xl mx-auto px-6 lg:px-12">
            ...
            <div class="mt-20 text-center">
                <h3 class="text-3xl font-bold text-slate-800 mb-12">Why Choose Nike Premium?</h3>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div class="space-y-4">
                        ...
                        <h4 class="text-lg font-semibold text-slate-800">Sustainable Materials</h4>
                        <p class="text-slate-600">Crafted with eco-friendly materials for a better tomorrow.</p>
                    </div>
                    <div class="space-y-4">
                        ...
                        <h4 class="text-lg font-semibold text-slate-800">Advanced Technology</h4>
                        <p class="text-slate-600">Cutting-edge innovation in every stitch and sole.</p>
                    </div>
                    <div class="space-y-4">
                        ...
                        <h4 class="text-lg font-semibold text-slate-800">Exclusive Design</h4>
                        <p class="text-slate-600">Limited editions you won't find anywhere else.</p>
                    </div>
                </div>
            </div>
        </div>

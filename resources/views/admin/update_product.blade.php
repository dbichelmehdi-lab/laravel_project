            ...
            <form action="{{ url('edit_product', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-6 gap-6">
                    ...
                    <div class="col-span-full">
                        ...
                        <textarea id="product-details" name="product_details" rows="6"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-4">{{$product->product_details}}</textarea>
                    </div>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        ...
                        <input type="file" name="image" id="image"
                            class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5"
                            value="{{$product->image}}" placeholder="Electronics">
                    </div>
